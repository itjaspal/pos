...
namespace api.Controllers
{
    public class MenuController : ApiController
    {
        ...
        //[POST("postCreate")]
        [Route("master-menu/postCreate")]
        public HttpResponseMessage postCreate(MasterMenuView model)
        {
            try
            {
                //check dupplicate Code
                var isDupplicate = menuSvc.CheckDupplicate(model.menuFunctionId);
                if (isDupplicate)
                {
